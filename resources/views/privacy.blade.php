...
<body>
    <p>Privacy Policy for PT. Media Mitrakarya Indonesia
        <br />
        At Indonesia Miner, accessible from https://indonesiaminer.com, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and recorded by Indonesia
        Miner and how we use it.
        <br />
        <br />
        ...
        to the information that they shared and/or collect in Indonesia Miner. This policy is not applicable to any
        ...
        Log Files
        <br />
        Indonesia Miner follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <br />
        Like any other website, Indonesia Miner uses 'cookies'. These cookies are used to store information including
        ...
        <br />
        You may consult this list to find the Privacy Policy for each of the advertising partners of Indonesia Miner.
        <br />
        <br />
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Indonesia Miner, which are sent directly to users'
        ...
        <br />
        <br />
        Note that Indonesia Miner has no access to or control over these cookies that are used by third-party
        advertisers.
        <br />
        <br />
        Third Party Privacy Policies
        <br />
        Indonesia Miner's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <br />
        <br />
        Indonesia Miner does not knowingly collect any Personal Identifiable Information from children under the age of
