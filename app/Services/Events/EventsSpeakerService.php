    ...
    public function listSpeakerSchedule($id)
    {
        return DB::table('events_schedule_speaker')
            ->select(
                ...
                'events_speaker.position_2 as position_2',
                'events_speaker.company_name_2 as company_2',
                'events_speaker.company_image_2 as company_image_2',
                'events_speaker.position_2 as position_2',
                'events_speaker.company_name_2 as company_2',
                'events_speaker.company_image_2 as company_image_2',
                'events_speaker.position_3 as position_3',
                'events_speaker.company_name_3 as company_3',
                'events_speaker.company_image_3 as company_image_3',
